...
$output = & $godot.FullName --headless --fixed-fps 60 --path $root "res://scenes/Room05.tscn" --quit-after 13000 -- --room05-solution-smoke 2>&1
$exitCode = $LASTEXITCODE
$ErrorActionPreference = "Stop"
$output | Write-Output
if ($exitCode -ne 0) {
    throw "Room 05 solution smoke test exited with code $exitCode"
}
