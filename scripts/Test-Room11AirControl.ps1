...
$output = & $godot.FullName --headless --fixed-fps 60 --path $root "res://scenes/Room11.tscn" --quit-after 1200 -- --room11-air-control-smoke 2>&1
...
if (($output -join "`n") -notmatch "ROOM11_AIR_CONTROL_PASS") {
    throw "Room 11 air-control smoke test exited without its pass marker."
}
