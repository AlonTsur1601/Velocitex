...
$output = & $godot.FullName --headless --path $root "res://scenes/FlightGateBoostSmokeTest.tscn" --flight-gate-boost-smoke 2>&1
$exitCode = $LASTEXITCODE
$ErrorActionPreference = "Stop"
$output | Write-Output
if ($exitCode -ne 0) {
    throw "Flight-gate boost smoke test exited with code $exitCode."
}
