...
& $godot.FullName --headless --path $root "res://scenes/AdvancementNotificationSmokeTest.tscn"
if ($LASTEXITCODE -ne 0) {
    throw "Advancement notification smoke test exited with code $LASTEXITCODE"
}
